...
public class StoreService {
    ...
    public double getPriceSync(String storeName) {
        System.out.printf("Getting prices sync for store %s", storeName);
    ...
    public CompletableFuture<Double> getPricesAsyncCompletableFuture(String storeName) {
        System.out.printf("Getting prices sync for store %s%n", storeName);
        // Completable future não usa executor, por baixo dos panos ele usa ForkJoinPool
        // Retorna um valor baseado no supplier passado, que irá ser usado para completar o CompletableFuture
